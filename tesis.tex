...
\caption{Proporción de varianza entre y dentro}\label{fig:unnamed-chunk-11}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{images/inter2} 

}

\caption{Interacción}\label{fig:unnamed-chunk-13}
\end{figure}
